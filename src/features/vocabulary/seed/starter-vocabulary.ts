...
const starterTopics = [
  {
    ...
    words: [
      ["hello", "hello", "xin chào", "/həˈloʊ/", "Hello, nice to meet you.", "Xin chào, rất vui được gặp bạn."],
  ...
  },
  {
    ...
    words: [
      ["konnichiwa", "こんにちは", "xin chào", "こんにちは", "こんにちは、皆さん。", "Xin chào mọi người."],
      ["ohayou", "おはよう", "chào buổi sáng", "おはよう", "おはようございます。", "Chào buổi sáng."],
      ["konbanwa", "こんばんは", "chào buổi tối", "こんばんは", "こんばんは、先生。", "Chào buổi tối, thầy/cô."],
      ["namae", "名前", "tên", "なまえ", "お名前は何ですか？", "Bạn tên là gì?"],
      ["arigatou", "ありがとう", "cảm ơn", "ありがとう", "ありがとうございます。", "Xin cảm ơn."],
      ["onegaishimasu", "お願いします", "làm ơn / nhờ bạn", "おねがいします", "よろしくお願いします。", "Rất mong được giúp đỡ."],
      ["sayounara", "さようなら", "tạm biệt", "さようなら", "先生、さようなら。", "Tạm biệt thầy/cô."],
      ["mata-ne", "またね", "hẹn gặp lại", "またね", "またね、明日。", "Hẹn gặp lại ngày mai."],
    ],
  },
  {
