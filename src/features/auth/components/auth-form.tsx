    ...
    <div className="w-full max-w-md">
      <div className="mb-8">
        <p className="eyebrow mb-3 text-primary">
          Không gian nhỏ để tiến bộ mỗi ngày
        </p>
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <button
                ...
                className="absolute inset-y-0 right-0 grid w-11 place-items-center rounded-r-xl text-muted-foreground hover:text-primary"
              >
                {showPassword ? (
